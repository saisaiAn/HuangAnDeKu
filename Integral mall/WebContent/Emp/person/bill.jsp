...
<link href="${pageContext.request.contextPath}/css/personal.css"
	rel="stylesheet" type="text/css">
<link href="${pageContext.request.contextPath}/css/blstyle.css"
	rel="stylesheet" type="text/css">
<script
	src="${pageContext.request.contextPath}/AmazeUI-2.4.2/assets/js/jquery.min.js"></script>
<script
	src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/one/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
</head>
				...
				<div class="user-bill">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf">
							<strong class="am-text-danger am-text-lg">账单</strong> / <small>Electronic&nbsp;bill</small>
						</div>
					</div>
					<hr />
					...
					<div class="ebill-section">
						<div class="ebill-title-section">
							<h2 class="trade-title section-title">
								交易 <span class="desc">（金额单位：元）</span>
							</h2>
						...
						<div class="module-income ng-scope">
							<div class="income-slider ">
								<div class="block-income block  fn-left">
									<h3 class="income-title block-title">
										支出 <span class="num ng-binding"> 119.80 </span> <span
											class="desc ng-binding"> <a href="billlist.jsp">查看支出明细</a>
										</span>
									</h3>

									<div ng-class="shoppingChart"
										class="catatory-details  fn-hide shopping">
												...
												<li class="ng-scope  delete-false">
													...
													<div class="  ng-scope">
														<a href="#" class="text fn-left " title="呢子大衣"> <span
															...
															class="amount fn-right ng-binding">349.00</span>
														</a>
													</div>
												</li>
												...
												<li class="ng-scope  delete-false">
													...
													<div class="  ng-scope">
														<a href="#" class="text fn-left " title="羊毛毡底鞋垫"> <span
															...
															class="amount fn-right ng-binding">9.90</span>
														</a>
													</div>
												</li>
								...
								<h3 class="expense income-title block-title">
									收入 <span class="num ng-binding"> 0.00 </span> <span
										class="desc ng-binding"> <a href="billlist.jsp">查看收入明细</a>
									</span>
								</h3>
							</div>
							...
							<div class="module-card inner-module">
								...
								<div class="card-chart valid am-slider am-slider-default"
											...
											<div class="cards-carousel">
												<div class="mask">
													...
													<div class="bank ng-binding"
														style="background-image: url(${pageContext.request.contextPath}/images/combo.png);">中国农业银行</div>
													<div class="details">
														<a>查看详情</a>
													</div>
												</div>
											...
											<div class="cards-details">
												<div class="bank-name">
													<div class="name fn-left"
														style="background-image: url(${pageContext.request.contextPath}/images/combo.png);"></div>
													<span class="close fn-right"><a>X</a></span>
												</div>
												<div class="bank-detail">
													<div class="totalin fn-left">
														<span class="fn-left">流入</span> <span
															class="amount fn-right">0.00</span>
													</div>
													<div class="totalout fn-left">
														<span class="fn-left">流出</span> <span
															class="amount fn-right">0.00</span>
													</div>
													<div class="expand fn-left">
														<span class="fn-left">支出</span> <span
															class="amount fn-right">0.00</span>
													</div>
													<div class="withdraw fn-left">
														<span class="fn-left">提现</span> <span
															class="amount fn-right"> 0.00 </span>
													</div>
													<div class="recharge fn-left">
														<span class="fn-left">充值</span> <span
															class="amount fn-right"> 0.00 </span>
													</div>

													<div class="refund fn-left">
														<span class="fn-left">银行卡退款</span> <span
															class="amount fn-right ">0.00</span>
													</div>
												</div>
											</div>
										...
										<li>
											<div class="cards-carousel">
												<div class="mask">
													...
													<div class="bac fn-left"></div>
													<div class="bank ng-binding"
														style="background-image: url(${pageContext.request.contextPath}/images/combo1.png);">中国建设银行</div>
													<div class="details">
														<a>查看详情</a>
													</div>
												</div>
											...
											<div class="cards-details">
												<div class="bank-name">
													<div class="name fn-left"
														style="background-image: url(${pageContext.request.contextPath}/images/combo1.png);"></div>
													<span class="close fn-right"><a>X</a></span>
												</div>
												<div class="bank-detail">
													<div class="totalin fn-left">
										...
										<li>
											<div class="cards-carousel">
												<div class="mask">
													...
													<div class="bac fn-left"></div>
													<div class="bank ng-binding"
														style="background-image: url(${pageContext.request.contextPath}/images/combo2.png);">浦发银行</div>
													<div class="details">
														<a>查看详情</a>
													</div>
												</div>
											...
											<div class="cards-details">
												<div class="bank-name">
													<div class="name fn-left"
														style="background-image: url(${pageContext.request.contextPath}/images/combo2.png);"></div>
													<span class="close fn-right"><a>X</a></span>
												</div>
												<div class="bank-detail">
													<div class="totalin fn-left">
										...
										<li>
											<div class="cards-carousel">
												<div class="mask">
													...
													<div class="bac fn-left"></div>
													<div class="bank ng-binding"
														style="background-image: url(${pageContext.request.contextPath}/images/combo3.png);">中国光大银行</div>
													<div class="details">
														<a>查看详情</a>
													</div>
												</div>
											...
											<div class="cards-details">
												<div class="bank-name">
													<div class="name fn-left"
														style="background-image: url(${pageContext.request.contextPath}/images/combo3.png);"></div>
													<span class="close fn-right"><a>X</a></span>
												</div>
												<div class="bank-detail">
													<div class="totalin fn-left">
	...
	<aside class="menu">
		<ul>
			...
			<li class="person">
				...
				<ul>
					<li><a href="${pageContext.request.contextPath}/Emp/person/order.jsp">订单管理</a></li>
				</ul>
			</li>
			<li class="person">
				<p>
				...
				<ul>
					<li><a href="${pageContext.request.contextPath}//integral/Integral_points">我的积分</a></li>
					<li><a href="${pageContext.request.contextPath}/Emp/person/bill.jsp">账单明细</a></li>
				</ul>
			</li>
