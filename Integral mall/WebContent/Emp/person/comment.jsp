...
<!--头 -->
					...
					<div class="am-container header">
						...
						<ul class="message-r">
							<div class="topMessage home">
								<div class="menu-hd"><a href="${pageContext.request.contextPath}/Emp/home/index.jsp" target="_top" class="h">商城首页</a></div>
							</div>
							<div class="topMessage my-shangcheng">
								<div class="menu-hd MyShangcheng"><a href="${pageContext.request.contextPath}/Emp/person/index.jsp" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div>
							</div>
		...
		<div class="nav-table">
			...
			<div class="nav-cont">
				<ul>
					<li class="index"><a href="${pageContext.request.contextPath}/Emp/person/index.jsp">首页</a></li>
		...
		<ul>
			...
			<li class="person">
				...
				<ul>
					...
					<li><a href="${pageContext.request.contextPath}/Emp/person/comment.jsp">评价商品</a></li>
				</ul>
			</li>
			<li class="person">
				<p>
