...
<body>
		...
		<div class="am-container header">
			...
			<ul class="message-r">
				<div class="topMessage home">
					<div class="menu-hd">
						<a href="${pageContext.request.contextPath}/Emp/home/index.jsp" target="_top" class="h">商城首页</a>
					</div>
				</div>
	...
	<div class="nav-table">
		...
		<form action="${pageContext.request.contextPath}/Emp/Emp_findown.action" method="post" >
		<div class="nav-cont">
			<ul>
				<li class="${pageContext.request.contextPath}/Emp/home/index.jsp"><a href="#">首页</a></li>
			...
			<div class="main-wrap">
					...
					<div class="wrap-list">
						<div class="m-user">
							...
							<div class="m-userinfo">
								...
								<div class="m-right">
									<div class="m-new">
										<a href="#"><i class="am-icon-dropbox  am-icon-md"
							...
							<div class="m-userproperty">
								...
								<p class="m-bill">
									<a href="pointnew.jsp"> <em class="m-num">${user.intergralno.remainingpoints}</em> <span
										class="m-title">剩余积分</span>
									</a>
								</p>
							</div>
						...
						<div class="user-squaredIcon">
							...
							<ul>
								...
								<a href="${pageContext.request.contextPath}/home/home2.jsp">
									<li class="am-u-sm-4"><i
						...
						<!--优惠券积分-->
						<div class="twoTab">
							<div class="twoTabModel Coupon" style="overflow: ">
								<h5 class="squareTitle">
									<a href="#"><span class="splitBorder"></span>精致生活<i
										class="am-icon-angle-right"></i></a>
										&nbsp;&nbsp;&nbsp;<img src="${pageContext.request.contextPath}/images/style.png"  />
								</h5>
								<div class="Box">
							...
							<div class="twoTabModel credit">
								<h5 class="squareTitle">
									<a href="#"><span class="splitBorder"></span>积分商城<i
										class="am-icon-angle-right"></i></a>
								</h5>
								<div class="Box">
									<p class="countDown">
									...
									<div class="am-slider am-slider-default am-slider-carousel"
										...
										<ul class="am-slides">
											<li><a href="#"><img
													src="${pageContext.request.contextPath}/images/333.jpg" /></a></li>
											<li><a href="#"><img
													src="${pageContext.request.contextPath}/images/222.jpg" /></a></li>
											<li><a href="#"><img
													src="${pageContext.request.contextPath}/images/111.jpg" /></a></li>
											<li><a href="#"><img
													src="${pageContext.request.contextPath}/images/333.jpg" /></a></li>
											<li><a href="#"><img
													src="${pageContext.request.contextPath}/images/222.jpg" /></a></li>
					...
					<div class="new-goods">
						...
						<div class="new-goods-info">
							<a class="shop-info" href="#" target="_blank">
								<div>
									<img src="${pageContext.request.contextPath}/images/666.jpg"
										alt="">
				...
				<div data-am-widget="tabs" class="am-tabs collection">
					<ul class="am-tabs-nav am-cf">
						<li class="am-active"><a href="[data-tab-panel-0]"><i
								class="am-icon-heart"></i>商品收藏</a></li>
						<li class=""><a href="[data-tab-panel-1]"><i
								class="am-icon-paw"></i>购物足迹</a></li>
					</ul>
					<div class="am-tabs-bd">
						...
						<div data-tab-panel-0 class="am-tab-panel am-active">
							<div class="am-slider am-slider-default am-slider-carousel"
								...
								<ul class="am-slides">
									<li><a><img class="am-thumbnail"
											src="${pageContext.request.contextPath}/images/EZA27501.jpg" /></a>
										<strong class="price">¥32.9</strong></li>
									<li><a><img class="am-thumbnail"
	...
	<!--引导 -->
	<div class="navCir">
		<li><a href="${pageContext.request.contextPath}/home/home2.jsp"><i
				class="am-icon-home "></i>首页</a></li>
		<li><a href="${pageContext.request.contextPath}/home/sort.jsp"><i
				class="am-icon-list"></i>分类</a></li>
		<li class="active"><a href="${pageContext.request.contextPath}/person/index.jsp"><i
