	...
	<div class="mt-logo">
		...
		<div class="am-container header">
			<ul class="message-l">
				...
				<div class="topMessage">
					<div class="menu-hd">
				<a href="${pageContext.request.contextPath}/Emp/home/login.jsp" target="_top" class="h">亲，请登录</a>	
					</div>
				</div>
			</ul>
					</div>
		...
		<div class="col-main">
			<div class="main-wrap">
				...
				<div class="user-info">
					...
					<!--个人信息 -->
					<div class="info-main">
						<form name = "phonefrom" class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/Emp/Emp_UpdEmpPhone.action?qtempno=${user.empno}" method="post">

							<div class="am-form-group" >
								<label for="user-name" class="am-form-label">部门</label>
								<div class="am-form-content">
									<input type="text" id="user-name2" placeholder="${user.department.depaname}" readonly="true">
								</div>
							</div>
						<div class="am-form-group" >
								<label for="user-name" class="am-form-label">职位</label>
								<div class="am-form-content">
									<input type="text" id="user-name2" placeholder="<c:if test="${user.position==1}">普通员工</c:if><c:if test="${user.position==2}">部门经理</c:if><c:if test="${user.position==3}">综合部经理</c:if><c:if test="${user.position==4}">校长</c:if>"
									readonly="true">
								</div>
							</div>
							...
							<div class="am-form-group">
								...
								<div class="am-form-content">
									<input type="text" id="user-name2" placeholder="${user.empname}" readonly="true">
							...
							<div class="am-form-content">
									<input type="text" id="user-name2" placeholder="${user.empsex}" readonly="true">
							...
							<div class="am-form-group">
								...
								<div class="am-form-content">
									<input id="user-phone" name="empphone" placeholder="${user.empphone}" value="${user.empphone}" type="tel">
									<%-- <input type="hidden" value="${user.empno}" name="qtempno"> --%>
								</div>
							</div>
