		...
		<div class="am-container header">
			<ul class="message-l">
				<div class="topMessage">
					<div class="menu-hd">
						<a href="${pageContext.request.contextPath}/Emp/login.jsp" target="_top" class="h">亲，请登录</a>
					</div>
				</div>
			</ul>
			<ul class="message-r">
				...
				<div class="points">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf">
							<strong class="am-text-danger am-text-lg">我的积分</strong> / <small>My&nbsp;Point</small>
						</div>
					</div>
					<hr />
					<div class="pointsTitle">
						...
						<div class="signIn">
							<a href="#"><i class="am-icon-calendar"></i>每日签到</a>
						</div>
					</div>
					<div class="pointshop">
						<a href="#"><i><img
								src="${pageContext.request.contextPath}/images/u5.png" /></i>积分商城</a>
					</div>
					<div class="pointlist" style="padding: 0px 10px;">
						<div class="pointTitle">
							<span>积分明细</span> <span class="more"><a href="points.jsp">查看更多<i
									class="am-icon-angle-right"></i></a></span>
						</div>
						<table>
							<tbody>
								<tr>
