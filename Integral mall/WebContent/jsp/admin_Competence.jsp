...
<body>
 <div class="margin clearfix">
   <div class="border clearfix">
       <span class="l_f">
        <a href="${pageContext.request.contextPath}/jsp/Competence.jsp" id="Competence_add" class="btn btn-warning" title="添加权限"><i class="fa fa-plus"></i> 添加权限</a>
...
function Competence_modify(id){
		window.location.href ="${pageContext.request.contextPath}/jsp/Competence.jsp?="+id;
};	
/*字数限制*/
